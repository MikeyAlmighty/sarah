...
- If the =constructor= does not contain a ~this()~ or ~super()~ reference, then the [[id:d5b4004d-b5db-48a2-8e85-09359ca61a42][javac]] *automatically* inserts ~super()~ with *no arguments* as the *first* line of the =constructor=.
