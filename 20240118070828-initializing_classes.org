...
#+property: header-args :tangle code/ocp/6/initializing_classes.java
...
1. The program first starts.
2. A ~static~ member of the class is *referenced*.
4. Shortly before an *instance* of the ~class~ is *created*.
