...
#+filetags: :OCP:
#+property: header-args :tangle code/ocp/3/pattern_matching.java
...
The ~type~ of the *pattern variable* must be a *subtype* of the variable on the =LHS= of the expression.
...
It might surprise you to learn this code does compile:
...
This means that when the last line of the method is reached, the input *must inherit* ~Integer~, and therefore data stays in scope
*even after* the [[id:17d8331e-1c9e-485e-9c45-b70bb2951275][if Statement]] ends.
