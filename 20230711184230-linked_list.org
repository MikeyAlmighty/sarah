...
| Search (by value)     | O(n)            | Linear search from head                   |
| Insert at head        | O(1)            | Directly update head pointer              |
| Insert at tail        | O(n)            | Traverse to end (unless tail pointer)     |
| Insert in middle      | O(n)            | Must find previous node to insert after   |
| Delete at head        | O(1)            | Move head pointer to next node            |
| Delete at tail        | O(n)            | Need to find second-to-last node          |
| Delete in middle      | O(n)            | Must find previous node to update pointer |

** [[id:3135ba46-5312-4651-9e80-fecad77c479b][Arrays]] vs [[id:f186ce91-693f-4f94-a382-f89915b76fd4][Linked List]]

| Operation             | Linked List                     | Array                                                                       |
|-----------------------+---------------------------------+-----------------------------------------------------------------------------|
| Push (Add to End)     | O(1)                            | O(1)                                                                        |
| Pop (Remove from End) | O(n)                            | O(1)                                                                        |
| Shift (Remove Start)  | O(1)                            | O(n)                                                                        |
| Unshift (Add Start)   | O(1)                            | O(n)                                                                        |
