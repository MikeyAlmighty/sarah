...
A *subclass* is also referred to as a *child class*, an *extended class*, or a *derived class*.
...
Note that you may have used the terms width and length to describe the sides of a rectangle in geometry.
