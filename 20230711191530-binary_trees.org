:PROPERTIES:
:ID:       ffa36760-294d-44fc-8168-9d377c54cd2a
:END:
#+title: Binary Trees
#+filetags: :DataStructure:
#+property: header-args :tangle code/datastructures/BinaryTree.js

* Binary Tree

[[https://www.youtube.com/watch?v=fAAZixBzIAI][Binary Tree Algorithms for Technical Interviews - Full Course]]
...
Node exploring can be achieved by either [[id:b3d3011e-5dd0-429c-833c-962a42ad09d2][BFS]] or [[id:0352da89-e0e5-41d8-bb1a-6b69d5d2cd3a][DFS]].
